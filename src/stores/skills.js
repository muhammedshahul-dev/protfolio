  ...
  const skills = [
    {
      ...
      skill: 'html',
      stack: 'front-end',
      name: skillLogos.html.name,
      color: skillLogos.html.color,
      svg: skillLogos.html.svg,
    },
    {
      id: crypto.randomUUID(),
      skill: 'javascript',
      stack: 'front-end',
      name: skillLogos.javascript.name,
      color: skillLogos.javascript.color,
      svg: skillLogos.javascript.svg,
    },
    {
      id: crypto.randomUUID(),
      skill: 'css',
      stack: 'front-end',
      name: skillLogos.css.name,
      color: skillLogos.css.color,
      svg: skillLogos.css.svg,
    },
    {
      id: crypto.randomUUID(),
      skill: 'tailwind',
      stack: 'front-end',
      name: skillLogos.tailwind.name,
      color: skillLogos.tailwind.color,
      svg: skillLogos.tailwind.svg,
    },
    {
      id: crypto.randomUUID(),
      skill: 'vue.js',
      stack: 'front-end',
      name: skillLogos['vue.js'].name,
      color: skillLogos['vue.js'].color,
      svg: skillLogos['vue.js'].svg,
    },
    {
      id: crypto.randomUUID(),
      skill: 'laravel',
      stack: 'back-end',
      name: skillLogos.laravel.name,
      color: skillLogos.laravel.color,
      svg: skillLogos.laravel.svg,
    },
    {
      id: crypto.randomUUID(),
      skill: 'php',
      stack: 'back-end',
      name: skillLogos.php.name,
      color: skillLogos.php.color,
      svg: skillLogos.php.svg,
    },
    {
      id: crypto.randomUUID(),
      skill: 'mysql',
      stack: 'back-end',
      name: skillLogos.sql.name,
      color: skillLogos.sql.color,
      svg: skillLogos.sql.svg,
    },
    {
      id: crypto.randomUUID(),
      skill: 'github',
      stack: 'tools',
      name: skillLogos.github.name,
      color: skillLogos.github.color,
